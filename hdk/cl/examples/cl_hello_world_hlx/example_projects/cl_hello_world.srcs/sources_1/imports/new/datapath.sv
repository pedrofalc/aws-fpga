...
//extends (M�dulo para ajustar entradas de 11 para 23 bits)
...
//Reduce(M�dulo para ajustar Sa�das de 24 para 12 bits)
...
-- O que recebe?
Entradas dos dados e a realimenta��o de registradores e vari�veis, al�m disso coloca as entradas em nos valores dos adders.
*/
...
-- O que recebe?
 Sa�da dos m�dulos da parte 2 e vari�veis.
*/
